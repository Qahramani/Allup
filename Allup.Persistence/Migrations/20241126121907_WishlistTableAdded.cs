...
{
    /// <inheritdoc />
    public partial class WishlistTableAdded : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TopText = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    BottomText = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceDetails_Languages_LanguageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceDetails_LanguageId",
                table: "ServiceDetails",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceDetails_ServiceId_LanguageId",
                table: "ServiceDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SliderDetails_SliderId_LanguageId",
                table: "SliderDetails",
